...
import { PERMISSIONS, getUserPermissions, hasPermission } from '@/lib/supabase'
...
export default function NewPropertyPage() {
  ...
  useEffect(() => {
    ...
    if (session?.user) {
      const userPermissions = getUserPermissions(session.user.role, session.user.permissions)
      if (!hasPermission(userPermissions, PERMISSIONS.PROPERTIES_CREATE)) {
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Add images and documents for your property
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    Enter a direct URL to an image that will be used as the main property photo
                  </p>
                </div>
